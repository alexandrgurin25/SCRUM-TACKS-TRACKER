...
import (
	...
	repository "projects/internal/repository/projects"
	service "projects/internal/service/projects"
	"projects/internal/transport/client"
	"projects/internal/transport/server"
	"github.com/AlexMickh/scrum-protos/pkg/api/projects"
	"projects/pkg/logger"
	"projects/pkg/postgres"
	"syscall"
	"time"
)
...
func main() {
	...
	projects.RegisterProjectsServer(grpcServer, srv)
